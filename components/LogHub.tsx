    ...
    <div className="animate-fade-in space-y-8 max-w-2xl mx-auto text-center">
      ...
      <div className="space-y-6">
        <Card
          ...
          className="cursor-pointer hover:border-[var(--primary-color-500)] transition-all duration-300 transform hover:scale-105 border-2 border-transparent"
        >
          <div className="flex flex-col items-center p-4">
            <PlayIcon size={40} className="mb-3 text-[var(--primary-color-400)]" />
