...
import { PlayIcon, PencilIcon, TrashIcon, PlusIcon, ChevronRightIcon, DragHandleIcon, ClipboardListIcon, ArrowUpIcon, ArrowDownIcon, BrainIcon } from './icons';
        ...
        <div key={session.id} draggable onDragStart={(e) => handleDragStart(e, session, weekId)} onDragEnd={handleDragEnd}>
            <div className="bg-slate-800 rounded-lg overflow-hidden group p-3">
                ...
                <div className="flex gap-2 mt-3 pt-3 border-t border-slate-700/50">
                    ...
                    <Button onClick={() => navigateTo('session-detail', { programId: program.id, sessionId: session.id })} variant="secondary" className="!py-1 !px-2 !text-xs flex-1"><BrainIcon size={12}/> Análisis</Button>
    ...
    return (
        <div draggable onDragStart={(e) => handleDragStart(e, session, weekId)} onDragEnd={handleDragEnd} className="bg-slate-800 rounded-lg p-2 space-y-2 text-xs cursor-grab">
            ...
            <div className="flex gap-1">
                ...
                <Button onClick={() => navigateTo('session-detail', { programId: program.id, sessionId: session.id })} variant="secondary" className="!p-1.5"><BrainIcon size={12}/></Button>
